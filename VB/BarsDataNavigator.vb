...
Namespace DevExpress.Demos.Navigator
	...
	Public Class AbstractDataNavigator
		...
		Protected Overridable Sub UpdateButtons()
			For Each link As ButtonLink In Buttons
				Select Case link.ActionType
					Case ActionType.EndEdit, ActionType.CancelEdit, ActionType.Delete, ActionType.First, ActionType.Prev
		...
		Public Overridable Sub PerformAction(ByVal action As ActionType)
			If CurrencyManager Is Nothing AndAlso CurrencyManager.Count > 0 Then
				Return
			End If
			Select Case action
		...
		Public Overrides Property Visible() As Boolean
			...
			Set(ByVal value As Boolean)
				If Button IsNot Nothing Then
					...
					Else
						Button.Visibility = BarItemVisibility.OnlyInCustomizing
					End If
				End If
			End Set
		End Property
