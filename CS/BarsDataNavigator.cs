...
namespace DevExpress.Demos.Navigator {
	public enum ActionType {None, First, Prev, Next, Last, Add, Delete, EndEdit, CancelEdit, Custom};
	...
	public class AbstractDataNavigator : Component {
		...
		public virtual void PerformAction(ActionType action) {
			if(CurrencyManager == null && CurrencyManager.Count > 0) return;
			switch(action) {
	...
	public class XtraBarsButtonsCollection : ButtonsCollection {
		public XtraBarsButtonsCollection(AbstractDataNavigator navigator) : base(navigator) {}
	...
	public class XtraBarsButtonLink : ButtonLink {
		...
		public new BarButtonItem Button {
			get { return base.Button as BarButtonItem; }
